...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__adc_table_column_vue__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    render: function render(h) {
        ...
        var ths = this.column.map(function (col, index) {
            if (col.thScopedSlot) {
    ...
    methods: {
        initChecked: function initChecked() {
            ...
            this.checked = JSON.parse(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(this.selection));
            var allChecked = this.data.length > 0 && __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.difference(this.data.map(function (item) {
                return item[_this.selectionKey];
            }), this.checked).length === 0 && this.checked.length === this.data.length;
        ...
        rows: function rows(h) {
            ...
            return this.data.map(function (item, index, data) {
                var tds = _this2.column.map(function (col) {
                    var visible = _this2.colIsVisible(col, item, index);
                    ...
                    if (col.defaultSlots) {
                        ...
                        if (col.vm.name !== '') {
                            ...
                            var checked = _this2.checked.indexOf(_this2.data[index][_this2.selectionKey]) > -1;
                            ...
                            if (col.filter !== '') {
                                if (typeof col.filter === 'string') {
                                    result = __WEBPACK_IMPORTED_MODULE_1_vue___default.a.filter(col.filter)(result);
                                } else {
                                    result = col.filter.apply(_this2.$parent, [result, item, index, col.prop]);
                                }
                            }
                            if (col.asHtml) {
                                return h('td', {
                                ...
                                if (typeof col.className !== 'undefined') {
                                    if (typeof col.className === 'string') {
                                        ...
                                        className += ' ' + col.className.apply(_this2.$parent, [result, item, index, col.prop]);
        ...
        checkAll: function checkAll() {
            ...
            if (this.allChecked) {
                if (this.selectionSave) {
                    this.checked = __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.unionWith(this.checked, checked);
                } else {
                    this.checked = checked;
                }
            } else {
                this.checked = __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.differenceWith(this.checked, checked);
            }
        ...
        checkOne: function checkOne(index) {
            ...
            return function (e) {
                var targetKey = _this3.data[index][_this3.selectionKey];

                if (e.target.checked && !_this3.checked.indexOf(targetKey) > -1) {
                    _this3.checked.push(targetKey);
                    var allChecked = _this3.data.length > 0 && __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.difference(_this3.data.map(function (item) {
                        return item[_this3.selectionKey];
                    }), _this3.checked).length === 0 && _this3.checked.length === _this3.data.length;

                    _this3.allChecked = allChecked;
                } else {
                    _this3.checked = __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.without(_this3.checked, targetKey);
                    _this3.allChecked = false;
                }
                _this3.$emit('check', { index: index, key: targetKey, checked: e.target.checked });
                _this3.$emit('change', _this3.checked);
            };
        },
    ...
    watch: {
        ...
        data: function data(newVal) {
            ...
            if (!this.selectionSave) {
                this.checked = __WEBPACK_IMPORTED_MODULE_2_lodash___default.a.intersection(this.checked, newVal.map(function (item) {
                    return item[_this4.selectionKey];
                }));
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    watch: {
        ...
        defaultSlots: function defaultSlots() {
            this.updateCol();
        },
        tdScopedSlot: function tdScopedSlot() {
            this.updateCol();
        },
        thScopedSlot: function thScopedSlot() {
            this.updateCol();
        }
    }
});
